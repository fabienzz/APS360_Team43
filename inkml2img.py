...
if __name__ == "__main__":
    ...
    import os
    i = 0
    data_path = "D:\\UT\APS360\\APS360_Team43\\CROHME_test_2011"
    store_path = "D:\\UT\APS360\\APS360_Team43\\APS360_Team43\\data\\c_2011_validation"
    for root,dir,files in os.walk(data_path):
        for file in files:
            if file.endswith('.inkml'):
                inkml2img(os.path.join(root,file), os.path.join(store_path,str(i)+'.png'))
                i += 1
